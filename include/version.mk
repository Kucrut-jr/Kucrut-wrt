...
VERSION_CODE:=$(if $(VERSION_CODE),$(VERSION_CODE),r33602-e717d133ed6d)

VERSION_REPO:=$(call qstrip,$(CONFIG_VERSION_REPO))
VERSION_REPO:=$(if $(VERSION_REPO),$(VERSION_REPO),https://downloads.immortalwrt.org/releases/24.10.4)
